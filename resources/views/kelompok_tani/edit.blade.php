...
<div class="form-container">
    ...
    <p class="description">Perbarui data kelompok tani sesuai kebutuhan.</p>
    ...
    <form action="{{ route('kelompok.update', $kelompok->id_kelompoktani) }}" method="POST">
        ...
        <input type="text" name="nama_kelompoktani"
               value="{{ old('nama_kelompoktani', $kelompok->nama_kelompoktani) }}"
        ...
        <input type="number" name="jumlah_kelompoktani"
               value="{{ old('jumlah_kelompoktani', $kelompok->jumlah_kelompoktani) }}"
        ...
        <input type="text" name="no_hp_kelompoktani"
               value="{{ old('no_hp_kelompoktani', $kelompok->no_hp_kelompoktani) }}"
        ...
        <input type="text" name="kabupaten"
               value="{{ old('kabupaten', $kelompok->kabupaten) }}"
        ...
        <textarea name="deskripsi_jalan" rows="3"
                  class="@error('deskripsi_jalan') is-invalid @enderror">{{ old('deskripsi_jalan', $kelompok->deskripsi_jalan) }}</textarea>
